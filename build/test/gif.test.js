...
describe('Gif', function () {
  ...
  describe('POST /gifs', function () {
    ...
    it('should post a gif', function (done) {
      _chai["default"].request(_app["default"]).post('/api/v1/gifs').set('Content-Type', 'application/x-www-form-urlencoded').set('authorization', employeeToken).field('title', 'Yeah').attach('image', _fs["default"].readFileSync('C:/Users/USER/Pictures/CSS/casey-horner-1057063-unsplash'), 'casey-horner-1057063-unsplash').end(function (err, res) {
